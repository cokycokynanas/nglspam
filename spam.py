...
# Versi dengan Info Baterai & Waktu Real-time
...
def get_system_info():
    ...
    # Coba jalankan termux-battery-status
    try:
        # Perintah ini hanya berfungsi di Termux dengan termux-api terinstal
        ...
        # Jika termux-api tidak terinstal atau tidak di Termux
        pass
...
def print_header():
    ...
    print(f"{CYAN}{BOLD}>>> NGL.LINK AUTOMATED SENDER v2.2 <<<{RESET}")
    print(f"{MAGENTA}{'=' * 60}{RESET}\n")
