...
# Versi dengan Logo ASCII Keren dan Penanganan Error 429
...
def print_header():
    ...
    print(f"{CYAN}{BOLD}>>> NGL.LINK AUTOMATED SENDER v2.1 (STABLE) <<<{RESET}")
    print(f"{MAGENTA}{'=' * 60}{RESET}\n")
...
def print_progress(current, total, bar_length=30):
    ...
    if total <= 0:
        # Jangan tampilkan progress bar jika total tidak terbatas
        return
