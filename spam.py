...
import base64
import itertools
import random # Diperlukan untuk Smart Delay
...
def clear_screen():
    ...
    # Catatan: Fungsi ini yang menyebabkan layar hitam jika crash setelah password.
    # Namun, karena ini adalah fitur UI, kita kembalikan. Jika crash terjadi, 
    # masalah ada di lingkungan Termux/izin Anda.
